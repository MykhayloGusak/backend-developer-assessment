...
const PolicyRepository = container.resolve("PolicyRepository");

describe("Repositories: Test Policy Classes", () => {
	test("Connect to Data Base and get policies", async done => {
		const result = await PolicyRepository.getAll();
