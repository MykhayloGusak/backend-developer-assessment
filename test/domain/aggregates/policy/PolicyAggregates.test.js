...
const PolicyAggregate = container.resolve("PolicyAggregate");

describe("Aggregates: Test Policy Classes", () => {
	test("Test Get Policy By id", async done => {
		const result = await PolicyAggregate.getById(
	...
	test("Test Get Policy By Client id", async done => {
		const result = await PolicyAggregate.getByClientId(
